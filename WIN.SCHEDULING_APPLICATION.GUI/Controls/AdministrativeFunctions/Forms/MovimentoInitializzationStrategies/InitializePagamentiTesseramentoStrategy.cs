...
{
    public class InitializePagamentiTesseramentoStrategy : IInitializzationStrategy
    {
        public void InitializeControls(MovimentoForm form, bool forCreation)
        {
            ...
            //layout group title
            form.layoutGroup.Text = "Pagamenti tesseramento Feneal";

            //form titolo
            form.Text = "Creazione o  aggiornamento pagamenti tesseramento";
        }
    }
}
