...
{
    public class InitializeContributoStrategy : IInitializzationStrategy
    {
        public void InitializeControls(MovimentoForm form, bool forCreation)
        {
            ...
            //regione
            form.layoutRegione.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Always;
            //provincia
            ...
            //layout group title
            form.layoutGroup.Text = "Contributi Feneal";

            //form titolo
            form.Text = "Creazione o  aggiornamento Contributo";
        }
    }
}
