...
{
    public partial class QuacPerProvinciaReport : DevExpress.XtraReports.UI.XtraReport
    {
        public QuacPerProvinciaReport()
        {
            InitializeComponent();
        }

        private void QuacPerProvinciaReport_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            string anno = "";
            string causale = "";
