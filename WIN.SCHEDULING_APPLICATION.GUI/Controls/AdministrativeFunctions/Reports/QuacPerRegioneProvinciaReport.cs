...
{
    public partial class QuacPerRegioneProvinciaReport : DevExpress.XtraReports.UI.XtraReport
    {
        public QuacPerRegioneProvinciaReport()
        {
            InitializeComponent();
        }

        private void QuacPerRegioneProvinciaReport_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            string anno = "";
            string causale = "";
