...
{
    public partial class RimesseReportControl : XtraUserControl
    {
        string fileLayout = "";
        TipoMovimernto _type = TipoMovimernto.RimessaTesseramento;
        string _layoutFileName = "\\LayoutSavings\\reportRimesse.xml";
        MovimentoForm frm;

        GridGroupSummaryItem titleItem = null;
        GridGroupSummaryItem titleItem1 = null;

        string orderBy = "";

        public RimesseReportControl()
        {
            InitializeComponent();
            cboAnno.Text = DateTime.Now.Year.ToString();
            titleItem = new GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Custom,  "Data", gridView1.Columns["Data"], "{0:c}");
        ...
        private  void LoadData(bool renewSuggestedDate)
        {
            try
            {
                ...
                MovimentoContabileSearchDTO dto = new MovimentoContabileSearchDTO(Convert.ToInt32(cboAnno.Text), null, null, null, true);
                dtos.Add(dto);
        ...
        private void cmdPrintList_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (gridView1.SortInfo.Count > 0)
                {
                    ...
                    orderBy = string.Format("per {0} {1}", i.Column.FieldName.ToLower(), sortType);
                }
        ...
        //    //brick = e.Graph.DrawString("Tesseramento " + cboAnno.Text, Color.Navy, new RectangleF(0, 0, 500, 40), DevExpress.XtraPrinting.BorderSide.None);
        ...
        //    brick.AutoWidth = true;
           ...
           // brick2.Font = new Font("Tahoma", 10, FontStyle.Bold);
            ...
            //GetDate(Convert.ToInt32( cboAnno.Text))
