...
{
    public partial class IncassiTesseramentoReportControl : DevExpress.XtraEditors.XtraUserControl
    {

        string fileLayout = "";
        TipoMovimernto _type = TipoMovimernto.IncassoTesseramento;
        string _layoutFileName = "\\LayoutSavings\\reportIncassiTesseramento.xml";
        MovimentoForm frm;
        GridGroupSummaryItem titleItem = null;

        public IncassiTesseramentoReportControl()
        {
            InitializeComponent();
        ...
        private void IncassiTesseramentoReportControl_Load(object sender, EventArgs e)
        {
            Init();
        }
