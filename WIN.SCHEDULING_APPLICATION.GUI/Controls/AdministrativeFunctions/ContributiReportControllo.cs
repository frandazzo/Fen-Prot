...
{
    public partial class ContributiReportControllo : DevExpress.XtraEditors.XtraUserControl
    {

             string fileLayout = "";
        TipoMovimernto _type = TipoMovimernto.Contribuzione;
        string _layoutFileName = "\\LayoutSavings\\reportIncassiTesseramento.xml";
        MovimentoForm frm;
        GridGroupSummaryItem titleItem = null;

        public ContributiReportControllo()
        {
            InitializeComponent();
        ...
        private void ContributiReportControllo_Load(object sender, EventArgs e)
        {
            Init();
        }
        ...
        private void Link_CreateMarginalHeaderArea(object sender, CreateAreaEventArgs e)
        {
            ...
            brick1 = e.Graph.DrawString("         Contributi territoriali " + cboAnno.Text, Color.Navy, new RectangleF(0, 0, 500, 40), DevExpress.XtraPrinting.BorderSide.None);
            ...
            brick2 = e.Graph.DrawString("Contributi effettuali dalla Feneal Nazionale \n alle strutture regionali e provinciali per l'anno  " + cboAnno.Text, Color.Navy, new RectangleF(0, 30, 600, 40), DevExpress.XtraPrinting.BorderSide.None);
