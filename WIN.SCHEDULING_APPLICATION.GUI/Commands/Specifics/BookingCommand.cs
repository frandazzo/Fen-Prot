...
{
        [SecureContext()]
    public class BookingCommand: OpenCommand
    {
            public BookingCommand(MainForm form)
            : base(form)
        {
        ...
        {
            return new BookingControl(_main );
        }
        ...
        {
            return "Calendario prenotazioni";
        }
        ...
        [Secure(Area = "Prenotazioni", Alias = "Calendario", MacroArea = "Applicativo")]
