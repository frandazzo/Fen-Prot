...
{
     [SecureContext()]
    public class BookingResourcesCommand: OpenCommand
    {
         public BookingResourcesCommand(MainForm form)
            : base(form)
        {
        ...
        [Secure(Area = "Stanze", Alias = "Visualizza", MacroArea = "Impostazioni")]
        protected override void SetTargetControlReceviers(BaseGUIControl control)
        {
            SecurityManager.Instance.Check();
            control.AddLinkCommand("BookingResources", new BookingResourcesCommand(_main));
